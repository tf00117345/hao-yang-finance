...
namespace hao_yang_finance_api.Migrations
{
    ...
    [Migration("20260902161845_AddInvoiceNumberUniqueIndex")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hao_yang_finance_api.Models.CollectionRequest", b =>
                {
                    ...
                    b.Property<string>("PaymentReceivedAt")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("hao_yang_finance_api.Models.DriverSettlement", b =>
                {
                    ...
                    b.Property<decimal>("FeeSplitAmount")
                        .HasColumnType("decimal(12,2)");
            ...
            modelBuilder.Entity("hao_yang_finance_api.Models.InvoiceAuditLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("SuggestedInvoiceNumber")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("suggested_invoice_number");
            ...
            modelBuilder.Entity("hao_yang_finance_api.Models.OutstandingBalance", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("hao_yang_finance_api.Models.WaybillFeeSplit", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("TargetDriverId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("target_driver_id");
                    ...
                    b.HasIndex("TargetDriverId");

                    b.HasIndex("WaybillId");

                    b.ToTable("waybill_fee_split");
                });
            ...
            modelBuilder.Entity("hao_yang_finance_api.Models.Waybill", b =>
                {
                    b.HasOne("hao_yang_finance_api.Models.CollectionRequest", "CollectionRequest")
                        .WithMany("Waybills")
            ...
            modelBuilder.Entity("hao_yang_finance_api.Models.WaybillFeeSplit", b =>
                {
                    b.HasOne("hao_yang_finance_api.Models.Driver", "TargetDriver")
                        .WithMany()
                        .HasForeignKey("TargetDriverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
